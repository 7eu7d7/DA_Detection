    ...
    def append_flipped_images(self):
        def flip():
            ...
            for i in range(num_images):
                ...
                entrys.append(entry)
            return entrys
        entrys = datasets.ds_utils.load_cache_data(f'{self.name} flipped images', os.path.join(self.cache_path, self.name + '_flipped_images.pkl'), flip)

        self.roidb.extend(entrys)
